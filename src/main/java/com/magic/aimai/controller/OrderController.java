...
public class OrderController extends BaseController {
    ...
    public ViewData queryOrder(Integer payStatus,Integer pageNO,Integer pageSize){
        ...
        try {
            ...
            return buildSuccessViewData(StatusConstant.SUCCESS_CODE,"获取成功",
                    orderService.queryOrderByItemsOfWeb(user.getId(),payStatus,pageNO,pageSize));
    ...
    public ViewData addOrder(Integer curriculumId,Integer number){
        try {
            User user = LoginHelper.getCurrentUserOfAPI();
            ...
            if(null == curriculum){
                return buildFailureJson(StatusConstant.OBJECT_NOT_EXIST,"课程不存在");
            }
