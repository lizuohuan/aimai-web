...
public class WxPayController extends BaseController {
    ...
    @ResponseBody
    public ViewData checkOrder(Integer orderId){
        ...
        try {
            ...
            return buildSuccessViewData(StatusConstant.SUCCESS_CODE,"查询成功",
                    1 == order.getPayStatus() ? 1 : 0);
        } catch (InterfaceCommonException e) {
            return buildFailureJson(e.getErrorCode(),e.getMessage());
        } catch (Exception e) {
            logger.error(e.getMessage(),e);
            return buildFailureJson(StatusConstant.Fail_CODE,"查询失败");
        }
...
//            Integer total_fee = 1;
            ...
            String callBack = req.getScheme() + "://" + req.getServerName() + ":" + req.getServerPort() + "/web";
            ...
            map.put("product_id", CommonUtil.buildOrderNumber());
            map.put("attach", JSONObject.fromObject(extendsParams).toString()); // 扩展参数
            ...
            data.put("code_url", obj.get("code_url"));
