    ...
    <div class="container aboutUs clearfix">
        <div class="menu">
            <ul class="shadow">
                ...
                <li><a href="javascript:void(0)" class="act">安巡</a></li>
                <li><a href="<%=request.getContextPath()%>/page/about/suggest">意见反馈</a></li>
            </ul>
        </div>
        <div class="content">
            <div class="shadow honor">
                <h2 class="aboutTitle">安巡<small class="upper">/polling</small></h2>
...
<script>
    ...
    webApp.controller("controller", function($scope) {
        ...
        $scope.content = null;
        config.ajaxRequestData(false, "content/info", {id : 4}, function (result) {
