    ...
    <div class="container register-container">
        <div class="register-bar">
            <form class="layui-form" id="formData">
                <marquee ng-show="userInfo.roleId == 4" direction="left" behavior="scroll" scrollamount="6" scrolldelay="0" loop="-1" hspace="5" vspace="5" style="margin-bottom: 46px !important;color: red;font-size: 14px;">
                    *请点击“允许”按钮，授权网页访问您的摄像头！
                    若您并未看到任何授权提示，则表示您的浏览器摄像头链接或您的机器没有连接摄像头设备。
                </marquee>
                <h2>注册</h2>
                <div class="row">
                    <div class="label-font" ng-show="userInfo.roleId == 2">机构名称</div>
                    <div class="label-font" ng-show="userInfo.roleId == 3">企业名称</div>
                    <div class="label-font" ng-show="userInfo.roleId == 4">姓名</div>
                    <div class="col-xs-12">
                        <input ng-show="userInfo.roleId == 2" type="text" name="showName" lay-verify="required" autocomplete="off" class="input government" placeholder="请输入机构名称" maxlength="20">
                        <input ng-show="userInfo.roleId == 3" type="text" name="showName" lay-verify="required" autocomplete="off" class="input company" placeholder="请输入企业名称" maxlength="20">
                        <input ng-show="userInfo.roleId == 4" type="text" name="showName" lay-verify="required" autocomplete="off" class="input personage" placeholder="请输入您的真实姓名" maxlength="20">
                    </div>
                </div>

                <div class="row">
                    <div class="label-font" ng-show="userInfo.roleId == 2">机构代码</div>
                    <div class="label-font" ng-show="userInfo.roleId == 3">营业执照编码</div>
                    <div class="label-font" ng-show="userInfo.roleId == 4">身份证号</div>
                    <div class="col-xs-12">
                        <input ng-show="userInfo.roleId == 2" type="text" lay-verify="required" class="input government" name="pid" autocomplete="off" placeholder="请输入机构代码" maxlength="20">
                        <input ng-show="userInfo.roleId == 3" type="text" lay-verify="required" class="input company" name="pid" autocomplete="off" placeholder="请输入营业执照编码" maxlength="20">
                        <input ng-show="userInfo.roleId == 4" type="text" lay-verify="required|isIdentityCard" class="input personage" name="pid" autocomplete="off" placeholder="请输入身份证号" maxlength="20">
                    </div>
                </div>

                <div class="row" ng-show="userInfo.roleId == 3">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <button class="blue-button" lay-submit="" lay-filter="finish">注册完成</button>
                    </div>
                    <div class="col-xs-12" style="margin: 10px 0 50px 0;text-align: center">
                        <%--<a href="#" class="agreement">《使用协议与条款》</a>--%>
                    </div>
                </div>
...
<form id="newUpload" method="post" enctype="multipart/form-data">
    ...
    <input name="app_id" value="e12e6865732543be9c4d39dab7994df2" type="hidden">
    <input name="app_key" value="3ca9a82d11fc444eb9fe8a4959560ac5" type="hidden">
...
<script>
    ...
    webApp.controller("controller", function($scope) {
        ...
        if ($scope.userInfo == null) {
            location.href = config.ip + "page/registerPhone";
        }
        ...
        layui.use(['form'], function(){
            ...
            form.on('submit(finish)', function(data) {
                ...
                data.field.roleId = $scope.userInfo.roleId;
                data.field.pwd = $scope.userInfo.password;
                data.field.phone = $scope.userInfo.phone;
                ...
                config.ajaxRequestData(false, "user/register", data.field, function (result) {
